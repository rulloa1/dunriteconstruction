...
export const Route = createFileRoute("/_authenticated/app/jobs/")({
  ...
  component: JobsIndex,
  pendingComponent: () => <AppShell title="Jobs"><LoadingBlock /></AppShell>,
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-3 grid grid-cols-3 gap-2 num text-sm">
                    ...
                    <div><div className="kbd-label">Margin</div><div className={`font-semibold ${marginTone(t.margin)}`}>{fmtPct(t.margin)}</div></div>
                  </div>
                </button>
              );
            })}
